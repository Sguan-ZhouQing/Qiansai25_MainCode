...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->screen, lv_color_hex(0x8ABDB0), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen, LV_GRAD_DIR_HOR, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui->screen, lv_color_hex(0x2b6494), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_cont_1, 0, 78);
    lv_obj_set_size(ui->screen_cont_1, 481, 243);
    ...
    lv_obj_set_style_bg_color(ui->screen_cont_1, lv_color_hex(0x8ABDB0), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_cont_1, LV_GRAD_DIR_VER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui->screen_cont_1, lv_color_hex(0xE1C0B0), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_main_stop(ui->screen_cont_1, 12, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_stop(ui->screen_cont_1, 170, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_btn_1_label, "login");
    lv_label_set_long_mode(ui->screen_btn_1_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->screen_btn_1_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->screen_btn_1, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->screen_btn_1_label, LV_PCT(100));
    lv_obj_set_pos(ui->screen_btn_1, 99, 132);
    lv_obj_set_size(ui->screen_btn_1, 310, 45);

    //Write style for screen_btn_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_btn_1, 70, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_btn_1, lv_color_hex(0xE1C0B0), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->screen_btn_1, lv_color_hex(0x060606), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_btn_1, &lv_font_montserratMedium_21, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_textarea_set_password_mode(ui->screen_ta_1, true);
    lv_textarea_set_one_line(ui->screen_ta_1, false);
    lv_textarea_set_accepted_chars(ui->screen_ta_1, "1234");
...
#endif
    lv_obj_set_pos(ui->screen_ta_1, 215, 42);
    ...
    lv_obj_set_style_bg_opa(ui->screen_ta_1, 210, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_ta_1, lv_color_hex(0xD4CBB2), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_label_2, "password:");
    lv_label_set_long_mode(ui->screen_label_2, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_2, 99, 62);
    lv_obj_set_size(ui->screen_label_2, 105, 27);
    ...
    lv_label_set_text(ui->screen_label_1, "智能语音药仓\n");
    lv_label_set_long_mode(ui->screen_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_1, 3, 0);
    lv_obj_set_size(ui->screen_label_1, 477, 78);
    ...
    lv_obj_set_style_text_letter_space(ui->screen_label_1, 8, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_label_1, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_label_1, 193, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_label_1, lv_color_hex(0x8ABDB0), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_label_1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_label_1, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui->screen_img_1, &_63_alpha_50x50);
    lv_img_set_pivot(ui->screen_img_1, 50,50);
    lv_img_set_angle(ui->screen_img_1, 0);
    lv_obj_set_pos(ui->screen_img_1, 31, 17);
    ...
    lv_img_set_src(ui->screen_img_2, &_65_alpha_50x50);
    lv_img_set_pivot(ui->screen_img_2, 50,50);
    lv_img_set_angle(ui->screen_img_2, 0);
    lv_obj_set_pos(ui->screen_img_2, 403, 17);
