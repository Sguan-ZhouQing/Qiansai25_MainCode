 ...
 * @LastEditTime: 2025-06-07 16:12:07
 * @FilePath: \demo_STM32F407code\Hardware\nRF24L01.c
 * @Description: 使用nRF24L01模块远程无线控制电控板，实现信号器件到功率器件的分离;
 * @Key_GPIO: PD2 -> GPIO_Output; PD3 -> GPIO_Output; PD4 -> GPIO_Input;
