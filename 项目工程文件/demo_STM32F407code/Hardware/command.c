/*
 * @Author: Keysking
 * @Date: 2025-05-26 15:31:14
 * @LastEditors: 星必尘Sguan|3464647102@qq.com
 * @LastEditTime: 2025-06-27 17:32:20
 * @FilePath: \demo_STM32F407code\Hardware\command.c
 * @Description: 使用环形循环缓存区，实现数据收发
 * @Key_GPIO: NULL;
 * 
...
uint8_t Command_GetCommand(uint8_t *command) {
    ...
    while (1) {
        ...
        // 如果不是包头 则跳过 重新开始寻找
        if (Command_Read(readIndex) != Data_Header) {
