...
// 直接操作 BSRR 寄存器（HAL 库下仍然可用）
#define LCD_CS_SET  (GPIOB->BSRR = (1U << LCD_CS))      // 置高
#define LCD_RS_SET  (GPIOB->BSRR = (1U << LCD_RS))      // 置高
#define LCD_RST_SET (GPIOB->BSRR = (1U << LCD_RST))     // 置高

#define LCD_CS_CLR  (GPIOB->BSRR = (1U << (LCD_CS + 16)))  // 置低
#define LCD_RS_CLR  (GPIOB->BSRR = (1U << (LCD_RS + 16)))  // 置低
#define LCD_RST_CLR (GPIOB->BSRR = (1U << (LCD_RST + 16))) // 置低
