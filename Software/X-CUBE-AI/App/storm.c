...
#define AI_NET_OBJ_INSTANCE g_storm
 
#undef AI_STORM_MODEL_SIGNATURE
#define AI_STORM_MODEL_SIGNATURE     "0x1b1fa9d2c4a261845d92da2a26cdad30"
...
#define AI_TOOLS_DATE_TIME   "2025-07-16T18:38:15+0800"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_STORM_N_BATCHES
#define AI_STORM_N_BATCHES         (1)

static ai_ptr g_storm_activations_map[1] = AI_C_ARRAY_INIT;
static ai_ptr g_storm_weights_map[1] = AI_C_ARRAY_INIT;
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, 0x0,
  AI_SHAPE_INIT(4, 1, 16, 16, 8), AI_STRIDE_INIT(4, 4, 4, 64, 1024),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  15, 0x0,
  AI_SHAPE_INIT(4, 2048, 16, 1, 1), AI_STRIDE_INIT(4, 1, 1024, 16384, 16384),
...
AI_LAYER_OBJ_DECLARE(
  _Reshape_output_0_to_chlast_layer, 8,
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 18536, 1, 1),
    18536, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 20916, 1, 1),
    20916, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_STORM_IN_NUM, &input_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_STORM_OUT_NUM, &output_output),
  &_conv1_Conv_output_0_layer, 0x8f27eecf, NULL)
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool storm_configure_activations(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)

  if (ai_platform_get_activations_map(g_storm_activations_map, 1, params)) {
    /* Updating activations (byte) offsets */
    
    input_output_array.data = AI_PTR(g_storm_activations_map[0] + 2448);
    input_output_array.data_start = AI_PTR(g_storm_activations_map[0] + 2448);
    _conv1_Conv_output_0_scratch0_array.data = AI_PTR(g_storm_activations_map[0] + 18832);
    _conv1_Conv_output_0_scratch0_array.data_start = AI_PTR(g_storm_activations_map[0] + 18832);
    _conv1_Conv_output_0_scratch1_array.data = AI_PTR(g_storm_activations_map[0] + 18868);
    _conv1_Conv_output_0_scratch1_array.data_start = AI_PTR(g_storm_activations_map[0] + 18868);
    _conv1_Conv_output_0_output_array.data = AI_PTR(g_storm_activations_map[0] + 1120);
    _conv1_Conv_output_0_output_array.data_start = AI_PTR(g_storm_activations_map[0] + 1120);
    _conv2_Conv_output_0_scratch0_array.data = AI_PTR(g_storm_activations_map[0] + 17504);
    _conv2_Conv_output_0_scratch0_array.data_start = AI_PTR(g_storm_activations_map[0] + 17504);
    _conv2_Conv_output_0_scratch1_array.data = AI_PTR(g_storm_activations_map[0] + 17648);
    _conv2_Conv_output_0_scratch1_array.data_start = AI_PTR(g_storm_activations_map[0] + 17648);
    _conv2_Conv_output_0_output_array.data = AI_PTR(g_storm_activations_map[0] + 0);
    _conv2_Conv_output_0_output_array.data_start = AI_PTR(g_storm_activations_map[0] + 0);
    _Reshape_output_0_to_chlast_output_array.data = AI_PTR(g_storm_activations_map[0] + 8192);
    _Reshape_output_0_to_chlast_output_array.data_start = AI_PTR(g_storm_activations_map[0] + 8192);
    _fc1_Gemm_output_0_output_array.data = AI_PTR(g_storm_activations_map[0] + 0);
    _fc1_Gemm_output_0_output_array.data_start = AI_PTR(g_storm_activations_map[0] + 0);
    _Relu_2_output_0_output_array.data = AI_PTR(g_storm_activations_map[0] + 64);
    _Relu_2_output_0_output_array.data_start = AI_PTR(g_storm_activations_map[0] + 64);
    output_output_array.data = AI_PTR(g_storm_activations_map[0] + 0);
    output_output_array.data_start = AI_PTR(g_storm_activations_map[0] + 0);
    return true;
  }
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool storm_configure_weights(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)

  if (ai_platform_get_weights_map(g_storm_weights_map, 1, params)) {
    /* Updating weights (byte) offsets */
    
    _conv1_Conv_output_0_weights_array.format |= AI_FMT_FLAG_CONST;
    _conv1_Conv_output_0_weights_array.data = AI_PTR(g_storm_weights_map[0] + 0);
    _conv1_Conv_output_0_weights_array.data_start = AI_PTR(g_storm_weights_map[0] + 0);
    _conv1_Conv_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _conv1_Conv_output_0_bias_array.data = AI_PTR(g_storm_weights_map[0] + 144);
    _conv1_Conv_output_0_bias_array.data_start = AI_PTR(g_storm_weights_map[0] + 144);
    _conv2_Conv_output_0_weights_array.format |= AI_FMT_FLAG_CONST;
    _conv2_Conv_output_0_weights_array.data = AI_PTR(g_storm_weights_map[0] + 160);
    _conv2_Conv_output_0_weights_array.data_start = AI_PTR(g_storm_weights_map[0] + 160);
    _conv2_Conv_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _conv2_Conv_output_0_bias_array.data = AI_PTR(g_storm_weights_map[0] + 1312);
    _conv2_Conv_output_0_bias_array.data_start = AI_PTR(g_storm_weights_map[0] + 1312);
    _fc1_Gemm_output_0_weights_array.format |= AI_FMT_FLAG_CONST;
    _fc1_Gemm_output_0_weights_array.data = AI_PTR(g_storm_weights_map[0] + 1408);
    _fc1_Gemm_output_0_weights_array.data_start = AI_PTR(g_storm_weights_map[0] + 1344);
    _fc1_Gemm_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _fc1_Gemm_output_0_bias_array.data = AI_PTR(g_storm_weights_map[0] + 17792);
    _fc1_Gemm_output_0_bias_array.data_start = AI_PTR(g_storm_weights_map[0] + 17792);
    output_weights_array.format |= AI_FMT_FLAG_CONST;
    output_weights_array.data = AI_PTR(g_storm_weights_map[0] + 17856);
    output_weights_array.data_start = AI_PTR(g_storm_weights_map[0] + 17856);
    output_bias_array.format |= AI_FMT_FLAG_CONST;
    output_bias_array.data = AI_PTR(g_storm_weights_map[0] + 18496);
    output_bias_array.data_start = AI_PTR(g_storm_weights_map[0] + 18496);
    return true;
  }
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_STORM_MODEL_NAME,
      .model_signature   = AI_STORM_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_error ai_storm_get_error(ai_handle network)
{
...
AI_API_ENTRY
ai_error ai_storm_create_and_init(
  ai_handle* network, const ai_handle activations[], const ai_handle weights[])
{
  ai_error err;
  ai_network_params params;

  err = ai_storm_create(network, AI_STORM_DATA_CONFIG);
  if (err.type != AI_ERROR_NONE) {
    return err;
  }
  
  if (ai_storm_data_params_get(&params) != true) {
    err = ai_storm_get_error(*network);
    return err;
  }
#if defined(AI_STORM_DATA_ACTIVATIONS_COUNT)
  /* set the addresses of the activations buffers */
  for (ai_u16 idx=0; activations && idx<params.map_activations.size; idx++) {
    AI_BUFFER_ARRAY_ITEM_SET_ADDRESS(&params.map_activations, idx, activations[idx]);
  }
#endif
#if defined(AI_STORM_DATA_WEIGHTS_COUNT)
  /* set the addresses of the weight buffers */
  for (ai_u16 idx=0; weights && idx<params.map_weights.size; idx++) {
    AI_BUFFER_ARRAY_ITEM_SET_ADDRESS(&params.map_weights, idx, weights[idx]);
  }
#endif
  if (ai_storm_init(*network, &params) != true) {
    err = ai_storm_get_error(*network);
  }
  return err;
}
...
AI_API_ENTRY
ai_buffer* ai_storm_inputs_get(ai_handle network, ai_u16 *n_buffer)
{
...
AI_API_ENTRY
ai_buffer* ai_storm_outputs_get(ai_handle network, ai_u16 *n_buffer)
{
  if (network == AI_HANDLE_NULL) {
    network = (ai_handle)&AI_NET_OBJ_INSTANCE;
    AI_NETWORK_OBJ(network)->magic = AI_MAGIC_CONTEXT_TOKEN;
...
AI_API_ENTRY
ai_handle ai_storm_destroy(ai_handle network)
{
  ...
  ai_handle network, const ai_network_params* params)
{
  ...
  ok &= storm_configure_weights(net_ctx, params);
  ok &= storm_configure_activations(net_ctx, params);
...
AI_API_ENTRY
ai_i32 ai_storm_forward(ai_handle network, const ai_buffer* input)
{
