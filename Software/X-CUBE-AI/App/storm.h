...
/******************************************************************************/
#define AI_STORM_MODEL_NAME          "storm"
#define AI_STORM_ORIGIN_MODEL_NAME   "ultratinycnn_stm32_64x64"

/******************************************************************************/
#define AI_STORM_ACTIVATIONS_ALIGNMENT   (4)
#define AI_STORM_INPUTS_IN_ACTIVATIONS   (4)
#define AI_STORM_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_STORM_IN_NUM        (1)

AI_DEPRECATED
#define AI_STORM_IN \
  ai_storm_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_STORM_IN_SIZE { \
  AI_STORM_IN_1_SIZE, \
}
#define AI_STORM_IN_SIZE_BYTES { \
  AI_STORM_IN_1_SIZE_BYTES, \
}
#define AI_STORM_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_STORM_IN_1_HEIGHT      (64)
#define AI_STORM_IN_1_WIDTH       (64)
#define AI_STORM_IN_1_CHANNEL     (1)
#define AI_STORM_IN_1_SIZE        (4096)
#define AI_STORM_IN_1_SIZE_BYTES  (16384)

/******************************************************************************/
#define AI_STORM_OUT_NUM       (1)

AI_DEPRECATED
#define AI_STORM_OUT \
  ai_storm_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_STORM_OUT_SIZE { \
  AI_STORM_OUT_1_SIZE, \
}
#define AI_STORM_OUT_SIZE_BYTES { \
  AI_STORM_OUT_1_SIZE_BYTES, \
}
#define AI_STORM_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_STORM_OUT_1_CHANNEL     (10)
#define AI_STORM_OUT_1_SIZE        (10)
#define AI_STORM_OUT_1_SIZE_BYTES  (40)

/******************************************************************************/
#define AI_STORM_N_NODES (6)
 ...
 * @ref ai_storm_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_storm_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_STORM_*
 * defines into file @ref storm.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
